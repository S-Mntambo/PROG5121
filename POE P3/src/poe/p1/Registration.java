...
public void sendMessage(){
 ...
 //Part 3      
       public void messageManagement(){
           ...
           int action = JOptionPane.showOptionDialog(null, "Massage management", "Management",JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
